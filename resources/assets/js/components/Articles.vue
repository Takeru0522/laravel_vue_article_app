<template>
    <div>
        <h2 class="my-4 text-center">Articles</h2>
        ...
        <div class="card mb-2" v-for="article in articles" v-bind:key="article.id">
            <div class="card-body">
                ...
                <div class="float-right">
                    <a @click="editArticle(article)" class="btn btn-warning mr-2">Edit</a>
                    <a @click="deleteArticle(article.id)" class="btn btn-danger">Delete</a>
                </div>
            </div>
        </div>
    </div>
